...
//        TODO: implement and use adapter Type-C => USB
        ...
        // adapter from Type-C to MicroUSB
        com.mobile.Legacy.MicroUsbCharger adapterTypeCToMicroUsb = new AdapterTypeCToMicroUsb(fastCharge);
        phone.pluginCharger((com.mobile.Legacy.MicroUsbCharger) adapterTypeCToMicroUsb);
        phone.charge(20);
        System.out.printf("Current power status = %s%n", phone.getChargingPercent());
